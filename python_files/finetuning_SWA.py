...
optimizer = torch.optim.SGD(model.parameters(), lr=0.001, momentum=0.9)  # Le lr ici est le lower bound
...
for epoch in range(40):  # Assuming 10 epochs
    ...
    with torch.no_grad():
        ...
        if test_accuracy > best_test_accuracy:
            ...
            torch.save(model.state_dict(), 'best_model_SWA_finetuning.pth')
        ...
        metrics_df.to_csv('model_performance_metric_swa_variable_lr.csv', index=False)